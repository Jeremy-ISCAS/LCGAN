...
def main():
    ...
    val_dataset = datasets.ImageFolder(os.path.join(args.data_path, "test"))
    ...
    model = fc_models.__dict__[args.arch](output_dim=0, eval_mode=True)
