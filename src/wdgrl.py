...
# from dutils import loop_iterable, set_requires_grad, GrayscaleToRgb
...
def gradient_penalty(critic, h_s, h_t):
    ...
    interpolates=interpolates.view(3,-1)
    ...
    gradient_norm = gradients.norm(2, dim=1)#### 返回输入张量给定维dim 上每行的p范数
